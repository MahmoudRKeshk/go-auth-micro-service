...
func (r *RefreshTokenPostgresRepository) GetRefreshTokenByTokenHashAndUserID(ctx context.Context, refreshTokenHash string, userID string) (*domain.RefreshToken, error) {
	query := `
...
func (r *RefreshTokenPostgresRepository) InsertRefreshToken(ctx context.Context, refreshToken *domain.RefreshToken) (*domain.RefreshToken, error) {
	query := `
